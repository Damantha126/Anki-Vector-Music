...
from AnkiVectorMusic.services.helpers.database import db, Database, dcmdb
...
async def handle_user_status(bot, cmd):
    ...
    if ban_status["is_banned"]:
        if (
            ...
            await cmd.reply_text("Sorry To Say! but **You are banned** 😂! Ask in **@AnkiSupport_Official** if you think this was an mistake.", quote=True)
            return
