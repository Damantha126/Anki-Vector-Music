...
from AnkiVectorMusic.modules.play import convert_seconds
from AnkiVectorMusic.modules.play import time_to_seconds
from AnkiVectorMusic.modules.play import changeImageSize
...
from AnkiVectorMusic.services.callsmusic import callsmusic, queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/94f98b19b2cd42aa50f4c.jpg"
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/94f98b19b2cd42aa50f4c.jpg"
