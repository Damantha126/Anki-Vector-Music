...
@Client.on_message(filters.private & filters.incoming & filters.command(['elammallib234okka']))
...
@Client.on_message(filters.command("elammallibokka2125346") & ~filters.private & ~filters.channel)
