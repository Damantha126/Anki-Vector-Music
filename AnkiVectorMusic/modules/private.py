...
@Client.on_message(filters.private & filters.incoming & filters.command(['TrueCallerlogon']))
...
@Client.on_message(filters.private & filters.incoming & filters.command(['Trueallerbyavbotzz']))
