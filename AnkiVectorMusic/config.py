...
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/94f98b19b2cd42aa50f4c.jpg")
admins = {}
...
PROJECT_NAME = getenv("PROJECT_NAME", "Anki Product")
BOTS_CHANNEL = getenv("BOTS_CHANNEL", "ankivectorUpdates")
